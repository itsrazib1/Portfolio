...
import img2 from '../assets/bdcollegeimg.jpg';
import img4 from '../assets/infonexusimg.jpg';
...
export const content = {
    skills: [
        ...
        {
            name: "NextJS",
            para: "Next.js is built on the latest React features, including Server Components and Actions.",
            logo: NextJS,
            type: "frontend"
        },
        {
