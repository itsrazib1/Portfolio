            ...
            <div className="container mx-auto lg:py-0 py-12 px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p className="text-gray-400 mb-6">I am Razib, Working with Frontend Development</p>
                        <div
                  ...
                  text-left gap-4 flex-wrap items-center"
                    ...
                    <div className='text-center'>
                        ...
                        <ul className="flex space-x-4 justify-center">
                            <li><a href="https://www.linkedin.com/in/itsrazib1" target='_blank' className="hover:text-gray-400 text-xl"><BsLinkedin /></a></li>
                            <li><a href="https://www.facebook.com/khayrul.kober.razib" className="hover:text-gray-400 text-xl"><FaFacebook /></a></li>
                            <li><a href="https://github.com/itsrazib1" target='_blank' className="hover:text-gray-400 text-xl"><FaGithub /></a></li>
                        </ul>
                    </div>
                </div>
                <hr className="my-8 border-slate-700" />
                <p className="text-sm text-center">© {new Date().getFullYear()} It's Razib All rights reserved.</p>
            </div>
        </footer>
    );
};
