            ...
            <div className="md:flex gap-14">
                ...
                <form data-aos="fade-left" action='https://formspree.io/f/moqoawnd' method='POST' className="md:w-8/12 overflow-hidden rounded text-slate-500 mb-8">
                    ...
                    <div className="flex justify-end px-6">
                            ...
                            <button type='submit'  className='w-full mb-3 relative inline-flex items-center justify-center p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500 btn border-0 '>
